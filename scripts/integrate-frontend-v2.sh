...
# Carefully integrate v2.0 frontend features into green
# This preserves all working code from blue while adding v2.0 enhancements

echo "=== Integrating Frontend v2.0 Features ==="

# Start with blue's working App.js
echo "1. Starting with working blue App.js..."
cp blue/mobile-app/App.js green/mobile-app/App-integrated.js

# Create a complete integrated App.js manually to ensure correctness
echo "2. Creating integrated App.js with v2.0 features..."

cat > green/mobile-app/App-integrated.js << 'EOF'
...
echo "✅ Created integrated App.js with all v2.0 features"
echo ""
echo "Features included:"
echo "- Desktop camera detection (hasCamera state)"
echo "- Drag & drop upload with visual feedback"
echo "- Paste support (Ctrl+V)"
echo "- ChatGPT-style upload UI"
echo "- Enhanced score displays (authenticity, Boca)"
echo "- Expandable details section"
echo "- All fixes from blue (no input.capture, TouchableOpacity, etc.)"

# Verify syntax
node -c green/mobile-app/App-integrated.js && echo "✅ Syntax valid" || echo "❌ Syntax error"