...
# Create the legal pages configuration
LEGAL_CONFIG=$(cat << EOF

    # Legal pages - serve static files directly
    location = /terms {
        alias $SITE_ROOT/mobile-app/terms.html;
    ...
    location = /privacy {
        alias $SITE_ROOT/mobile-app/privacy.html;
        default_type text/html;
