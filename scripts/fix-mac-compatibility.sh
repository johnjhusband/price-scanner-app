...
# Fix Mac compatibility issues for drag & drop and paste in green environment

echo "=== Fixing Mac Compatibility Issues ==="

# Create the fixed App.js with Mac compatibility improvements
cat > green/mobile-app/App-mac-fixed.js << 'EOF'
...
echo "✅ Created App-mac-fixed.js with Mac compatibility improvements"

# Replace the current App.js with the fixed version
echo -e "\nBacking up current App.js..."
cp green/mobile-app/App.js green/mobile-app/App-before-mac-fix.js

echo "Applying Mac fixes..."
cp green/mobile-app/App-mac-fixed.js green/mobile-app/App.js

echo -e "\n=== Mac Compatibility Fixes Applied ==="
echo "✅ Added preventDefault() to paste handler"
echo "✅ Enhanced drag & drop with stopPropagation() and dropEffect"
echo "✅ Added support for HEIC/HEIF image formats"
echo "✅ Improved clipboard data access for Safari"
echo "✅ Added capture phase event listeners"
echo "✅ Better file type detection with fallbacks"
echo "✅ Added document-level drag prevention"
echo "✅ Enhanced console logging for debugging"

echo -e "\nThe fixed version includes:"
echo "1. Better paste handling for Mac Safari and Chrome"
echo "2. Improved drag & drop with proper event handling"
echo "3. Support for Mac-specific image formats (HEIC/HEIF)"
echo "4. More robust file type checking"
echo "5. Enhanced debugging logs to help diagnose issues"

echo -e "\nTo deploy these fixes:"
echo "cd green/mobile-app"
echo "sudo docker build -t thrifting-buddy/frontend:green-mac-fix ."
echo "# Then update docker-compose and restart"